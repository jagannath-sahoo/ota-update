...
#else
#define DEV_ADDRESS	0x32
#define SENSITIVITY	0.24
#endif
...
/**
  * @brief Reading Accelerometer data from sensor
  * @param int16_t type buffer array for receiving data
  * @retval return int16_t type array buffer with data
	*/
